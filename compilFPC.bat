...
c:\Development\FreePascal\fpc\bin\i386-win32\fpc.exe -B -MObjFPC -Scgi -CX -O2 -XX -ve -FiD:\Dev\Lib -FuD:\Dev\Lib -FuD:\Dev\Lib\SQLite3 -l -FlD:\Dev\Lib\fpc-win32 -FED:\Dev\Lib\tempbuild\fpc TestSQL3.dpr >D:\Dev\Lib\tempbuild\fpc\compilation
