 ...
 *
 *
 * `Buffer.cpFrom(string, encodingNum): Buffer`:
 * 
...
function getBufferLength(size) {
    return size * 1 > binding.kMaxLength ?  -1 : size >>> 0;
}
...
function createUnsafeArrayBuffer(size) {
  ...
  try {
    //Orel. Fixes for Spidermonkey
    return new ArrayBuffer(getBufferLength(size));
  } finally {
    zeroFill[0] = 1;
  }
}
