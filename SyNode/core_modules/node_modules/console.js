...
function() {
    this._stdout.write(util.format.apply(this, arguments), 2); //UB specific
} :
function() {
};
...
Console.prototype.warn = function() {
  this._stderr.write(util.format.apply(this, arguments), 4); //UB specific
};
...
Console.prototype.error = function() {
  this._stderr.write(util.format.apply(this, arguments), 5); //UB specific
};
