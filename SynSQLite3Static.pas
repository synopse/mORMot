/// SQLite3 3.25.0 Database engine - statically linked for Windows/Linux 32 bit
...

{
  ...
  ***** END LICENSE BLOCK *****
    ...
    Statically linked SQLite3 3.25.0 engine
   *****************************************
...
const
  ...
  EXPECTED_SQLITE3_VERSION = {$ifdef ANDROID}''{$else}'3.25.0'{$endif};
