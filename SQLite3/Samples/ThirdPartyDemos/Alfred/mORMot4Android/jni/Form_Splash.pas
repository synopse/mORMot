...
Constructor jForm_Splash.Create(Owner : jForm);
 begin
  ...
  // Resource Extract
  Asset_SaveToFile('mormot.jpg'  ,App.Paths.Dat+'/mormot.jpg');
  Asset_SaveToFile('Synopse.png',App.Paths.Dat+'/Synopse.png');
  // Create Controls ----------------------------------------------------------
...
Procedure jForm_Splash.Timer_OnTimer(Sender : TObject);
 begin
  ...
  If Cnt_timer < ((App.Device.ScreenWH.height)-400) then Exit;
  Timer.Enabled := False;
  Close;
 end;
