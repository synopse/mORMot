...

{
  ...
  ***** END LICENSE BLOCK *****
       ...
       SQLite3 3.8.10.1 database engine
      **********************************
  ...
  - updated SQLite3 engine to latest version 3.8.10.1
...
type
  ...
  public
    ...
    //  - currently returns '3.8.10.1', when used with our SynSQLite3Static unit
    ...
    {/ Register Commit Notification Callbacks
     ...
     - The sqlite3.commit_hook(D,C,P) function returns the P argument from the
